...
const getAppDownloadUrl = () => {
  ...
  const paths: Record<OS, string> = {
    mac: `${baseUrl}files/app/mac`,
    win: `${baseUrl}files/app/win`,
    linux: `${baseUrl}files/app/linux`,
  };
...
const osIcons: Record<OS, React.FC<{ className?: string }>> = {
  win: WindowsIcon,
  mac: AppleIcon,
  linux: LinuxIcon,
};
          ...
          {appDownloadUrl ? (
            ...
            >
              <span className="flex items-center gap-2">
                {os && React.createElement(osIcons[os], { className: "w-5 h-5" })}
                Download App
              </span>
            </a>
          ) : (
